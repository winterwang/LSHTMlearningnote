...
par(mfrow=c(1,2))
hist(Mean_siblings$uhat_eb, 
     freq = FALSE, breaks = 30,
     ylab = "Density", 
     xlab = "EB estimates of un-standardised u_0",
     col='lightblue')
qqnorm(Mean_siblings$uhat_eb, 
       pch = 20,
       ylab = "unstandardized EB u_hat (mother level)"); qqline(Mean_siblings$uhat_eb, col=2)
```
...
par(mfrow=c(1,2))
hist(Mean_siblings$uhat_st, 
     freq = FALSE, breaks = 30,
     ylab = "Density", 
     xlab = "EB estimates of standardised u_0",
     col='lightblue')
qqnorm(Mean_siblings$uhat_st, 
       ylab = "standardized EB u_hat (mother level)", 
       pch = 20); qqline(Mean_siblings$uhat_st, col=2)
```
...
hist(siblings$ehat, 
     ...
     xlab = "standardised e",
     col='lightblue')
qqnorm(siblings$ehat, 
       ylab = "standardized ehat (child level)", 
       pch = 20); qqline(siblings$ehat, col=2)
```
