...
qqnorm(School_res0[,1], 
       ylab = "", 
       main = "BLUP r.e level 2 (school) intercept residuals", 
       pch = 20); qqline(School_res0[,1], col=2)
qqnorm(School_res0[,2], 
       ylab = "", 
       main = "BLUP r.e level 2 (school) slope residuals", 
       pch = 20); qqline(School_res0[,2], col=2)
```
...
qqnorm(School_res1[,1], 
       ylab = "", 
       main = "BLUP r.e level 2 (school) intercept residuals", 
       pch = 20); qqline(School_res1[,1], col=2)
qqnorm(School_res1[,2], 
       ylab = "", 
       main = "BLUP r.e level 2 (school) slope residuals", 
