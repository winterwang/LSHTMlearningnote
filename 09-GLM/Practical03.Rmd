...
Insect_long <- Insect[,-5] %>%
  pivot_longer(cols = c(-dose, -n_deaths, -n_subjects), names_to = "Fitted", values_to = "probability") %>%
...
Insect_long <- Insect[,-c(5,7)] %>%
  pivot_longer(cols = c(-n_deaths, -n_subjects, -dose), names_to = "Fitted", values_to = "probability") %>%
      arrange(Fitted, dose, n_subjects, n_deaths)
