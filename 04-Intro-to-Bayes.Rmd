...
- $\text{Pr}(A)=$ 珠寶帶你發生盜竊案的概率 -- 先驗概率 (prior probability);
...
$$
\begin{aligned}
& \text{Pr (1 girl in family of 2 kids | family does not have 2 girls)} \\
&= \frac{\text{Pr(family does not have 2 girls|1 girl in a family of 2 kids)}\times\text{Pr(1 girl in a family of 2 kids)}}{\sum_{j=0,1,2}\text{Pr(family does not have 2 girls|j girl in a family of 2 kids)}\times\text{Pr(j girl in a family of 2 kids)}} \\
