...
```{r OpenBUGSPractical0404, cache=TRUE, fig.width=7, fig.height=3, fig.cap='History plot showing 1000 samples of beta1', fig.align='center', out.width='80%', message=FALSE, warning=FALSE, echo=FALSE}
plot(chain$theta6[1:1000], main="theta[6]", type="l", ylim = c(-0, 1.2),
         ylab="beta[6]", xlab="iteration", col="red")
```
