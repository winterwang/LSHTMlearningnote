...
```{r BayesianPractical0602, cache=TRUE, fig.width=7, fig.height=9, fig.cap='History plots for iterations 1-1000 for the GREAT trial.', fig.align='center', out.width='80%', message=FALSE, warning=FALSE, echo=TRUE}
...
```{r BayesianPractical0609, cache=TRUE, fig.width=7, fig.height=9, fig.cap='Density plots for parameters prediction in GREAT trial first prior.', fig.align='center', out.width='80%', message=FALSE, warning=FALSE, echo=TRUE}
# Step 1 check model
