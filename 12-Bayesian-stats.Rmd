...
本書中我們用 [OpenBUGS](http://www.openbugs.net/w/FrontPage) 和 JAGS 軟件進行貝葉斯統計分析。
...
# Step 1 check model
jagsModel <- jags.model(file = paste(bugpath, "/backupfiles/coinmodel30.txt", sep = ""), n.chains = 1)
