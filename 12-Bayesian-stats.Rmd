...
```{r normalconjugate, cache=TRUE, fig.width=4.5, fig.height=4.5, fig.cap='Prior, likelihood and posterior for THM example.', fig.align='center', out.width='80%', message=TRUE, warning=FALSE}
...
plot(xseq, densities, col="darkgreen",xlab="mean THM concentration, ug/l (theta)", 
     ...
     cex.axis=1.3, cex.lab = 1.3, ylim = c(0,0.12))
