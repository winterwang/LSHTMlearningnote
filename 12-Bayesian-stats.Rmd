...
```{r　R-OpenBUGS00 12-Bayesian-stats-1, cache=TRUE, fig.width=4, fig.cap='History of the iterations.', fig.align='center', out.width='80%', message=TRUE, warning=FALSE}
library(BRugs)
# Step 1 check model
...
```{r　R-OpenBUGS01 12-Bayesian-stats-2, cache=TRUE, fig.width=4, fig.height=3.5, fig.cap='Predictive distribution of the nodes of interest.', fig.align='center', out.width='80%', message=TRUE, warning=FALSE}
...
```{r　R-OpenBUGS02 12-Bayesian-stats-3, cache=TRUE, fig.width=7, fig.height=3.5, fig.cap='Predictive distribution of the nodes of interest.', fig.align='center', out.width='80%', message=TRUE, warning=FALSE}
...
```{r　R-OpenBUGS03 12-Bayesian-stats-4, cache=TRUE, fig.width=7, fig.height=3.5, fig.cap='Predictive distribution of the nodes of interest.', fig.align='center', out.width='80%', message=TRUE, warning=FALSE}
...
```{r　R-OpenBUGS04 12-Bayesian-stats-5, cache=TRUE, message=TRUE, warning=FALSE}
...
```{r　R-OpenBUGS05 12-Bayesian-stats-6, cache=TRUE, fig.width=3.5, fig.height=3, fig.cap='Predictive distribution of the nodes of interest.', fig.align='center', out.width='80%', message=TRUE, warning=FALSE}
...
```{r　R-OpenBUGS06 12-Bayesian-stats-7, cache=TRUE, fig.width=7, fig.height=3, fig.cap='Predictive distribution of the nodes of interest.', fig.align='center', out.width='80%', message=TRUE, warning=FALSE}
...
在較爲廣義的條件下(broacd conditions)，參數的可交換定義在數學上等價於認爲 $\theta_1, \dots, \theta_J$ 來自於一個共同的先驗概率分佈 (common prior distribution)，只是它的參數是**未知的** (with **unkown** parameters)。
...
- 允許加入非嵌套變量，交叉變量 (non-nexted/cross-classified)，例如不同GP的病人，他們參加治療的醫院或許各不相同。
