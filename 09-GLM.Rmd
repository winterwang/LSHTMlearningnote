...
```{r loess-smoother2, echo=TRUE, fig.width=7, fig.height=10, fig.cap="Lowess smoother, with bandwith/span set to 0.0.4, for the menetal data", fig.align='center', out.width='100%', cache=TRUE, message=FALSE, warning=FALSE}
library(ggplot2)
ggplot(Mental, aes(Before, After)) + geom_point() +
