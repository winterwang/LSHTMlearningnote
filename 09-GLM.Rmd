...
有兩種方式對結果變量是二分類變量的實驗數據作表格歸納。其一，配對與否的信息被忽略掉 (圖 \@ref(fig:unmatchedGLM12-1a))；其二，包含配對信息 (圖 \@ref(fig:matchedGLM12-1b))。
...
kable(dt, "html",  align = "c", caption = "Matched presentation of data from a study with binary outcome and binary treatment") %>%
  ...
  add_header_above(c(" " = 1,"Standard treatment" = 4))
```
