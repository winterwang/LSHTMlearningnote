...
```{r epi-adjustment, echo=FALSE, fig.asp=.7, fig.width=7, fig.cap='relationships between three variables in an underlying population of interest', fig.align='center', out.width='90%'}
...
- 圖 \@ref(fig:epi-adjustment) - (a) $W$ 和 $X, D$ 都沒有關係，那麼我們研究 $X,D$ 之間的關係時，完全可以忽略掉 $W$，不用調整。<br> 但是，如果在邏輯迴歸模型中調整了一個和暴露變量結果變量之間無關的變量，獲得的
- 圖 \@ref(fig:epi-adjustment) - (b)
