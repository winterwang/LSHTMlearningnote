...
\begin{aligned}
             Y_{ij} & = C_j + P_i + O_{ij} \\
\text{Where} Y_{ij} & = \text{outcome for block} i \text{under condition (or exposure/treatment) } j\\
                C_j & = \text{component of outcome due to condition (or exposure/treatment) } j \\
