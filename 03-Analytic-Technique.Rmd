...
## 情況2：對均值進行假設檢驗 (方差未知) the one-sample t-test
...
$$
\begin{equation}
P_{O_{00}} = \text{Prob}(O_{00},O_{01},O_{10},O_{11}|O_{0\cdot},O_{1\cdot},O_{\cdot0},O_{\cdot1}) = \frac{O_{0\cdot}!O_{1\cdot}!O_{\cdot0}!O_{\cdot1}!}{O_{\cdot\cdot}!O_{00}!O_{01}!O_{10}!O_{11}!}
\end{equation}
(\#eq:AT4-Fisher)
$$
