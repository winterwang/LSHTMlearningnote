...
The Inference lectures were orgainised and taught by Professor [Timothy Collier](https://www.lshtm.ac.uk/aboutus/people/collier.timothy).
```
...
```{r diff-dispersion, echo=FALSE, fig.align='center', fig.cap='Distributions with similar central location but different dispersion', fig.height=8, fig.width=6, out.width='80%', cache=TRUE}
par(mfrow=c(2,1))
set.seed(1234)
a <- rnorm(10000,50, 5)
b <- rnorm(10000, 50, 10)
