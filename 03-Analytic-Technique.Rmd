...
$$
\begin{equation}
Z_r = \frac{1}{2}log_e(\frac{1+r}{1-r}) = \text{tanh}^{-1} (r)
\end{equation}
(\#eq:AT4-4)
$$
...
$$
\begin{equation}
Z_r \sim N(\frac{1}{2}log_e(\frac{1+\rho}{1-\rho}), \frac{1}{n-3})
\end{equation}
(\#eq:AT4-5)
$$
...
$$
\text{Test statistics} = \frac{Z_{r_2}-Z_{r_1}}{\sqrt{\frac{1}{n_2-3}+\sqrt{\frac{1}{n_1-3}}}} \sim N(0,1)
$$
