```{r ch12-guard-session03, include=FALSE}
...
# mcmcplots::traplot replaced with coda::traceplot (mcmcplots not available for R 4.5)
traceplot(as.mcmc(post.jags), ask = FALSE)
```
