...
```{r BayesianPractical0701, cache=FALSE, fig.width=7, fig.height=15, fig.cap='Density plots for parameters for GLM about the odds of malaria regarding netbeds use in Gambia children.', fig.align='center', out.width='80%', message=TRUE, warning=FALSE, echo=TRUE}
