```{r ch12-guard-practical02, include=FALSE}
if (!exists("bugpath", inherits = FALSE)) source("../R/global_setup.R", chdir = FALSE)
```
...
# Show the trace plot
# library(mcmcplots)  # not available for R 4.5; using coda equivalents
