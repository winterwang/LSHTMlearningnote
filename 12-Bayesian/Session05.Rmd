...
```{r BayesianChapter0510, cache=FALSE, fig.width=7, fig.height=5, fig.cap='Autocorrelation plot for the Gambia example (uncentered model, chain 1-2)', fig.align='center', out.width='80%', message=FALSE, warning=FALSE, echo=FALSE}
# knitr::include_graphics("../img/BayesianChapter0510-1.png")
Simulated <- coda::as.mcmc(jagsModel)
ggSample <- ggs(Simulated)
...
```{r BayesianChapter0515, cache=FALSE, fig.width=7, fig.height=5, fig.cap='Change in weight per month increase in age (posterior mean: 0.164 kg, 95% credible interval (0.143, 0.186)', fig.align='center', out.width='80%', message=FALSE, warning=FALSE, echo=FALSE}
...
```{r BayesianChapter0516, cache=FALSE, fig.width=7, fig.height=5, fig.cap='Change in weight for girls compared to boys (posterior mean: -0.520 kg, 95% credible interval (-0.880, -0.160)', fig.align='center', out.width='80%', message=FALSE, warning=FALSE, echo=FALSE}
Gamma <- ggSample %>% 
