...
```{r BayesianPractical0801, cache=FALSE, fig.width=8, fig.height=20, fig.cap='Density plots for parameters for hierarchical GLM about the odds of malaria regarding netbeds use in Gambia children.', fig.align='center', out.width='80%', message=TRUE, warning=FALSE, echo=TRUE}
# Read in the data: 
