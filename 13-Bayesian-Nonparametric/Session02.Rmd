...
```{r BNP02-fig2, cache=TRUE, echo=FALSE, fig.asp=.7, fig.width=6, fig.align='center', out.width='90%', fig.cap="G samples from the same Dirichlet Process with a series a partitions."}
knitr::include_graphics(paste0(bugpath, "/img/Gsampling with a.png"))
```

之前在貝葉斯統計學章節討論橫斷面研究時 (Chapter \@ref(bayes-crosssectional)) 曾經使用果狄雷克雷分佈作爲一個先驗概率，當時提到果狄雷克雷分佈的一些性質。這裏重新在補充一下：
