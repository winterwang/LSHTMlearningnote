...
pkg <- c("knitr", "kfigr", "tidyverse", "survival", "ggfortify", "survminer", "plotly","gridExtra", "Epi", "KMsurv", "gnm", "cmprsk", "mstate", "flexsurv", "splines", "epitools", "eha", "shiny", "epiR")
...
library(abind)
whitehal_array <- abind(split(whitehal_table, whitehal_table$agecat), along=3)
