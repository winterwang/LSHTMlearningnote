...
<caption>Table 1: The probability of observing $X=4$</caption>
 <thead><tr>
...
```{r binomial_likelihood, fig.asp=.7, fig.width=6, message=FALSE, warning=FALSE, fig.cap='Binomial Likelihood', fig.align='center', out.width='90%'}
x <- seq(0,1,by=0.001)
...
<table class="table table-striped table-bordered" style="margin-left: auto; margin-right: auto;">
<caption>Exercise 1 answer</caption>
 <thead><tr>
<th style="text-align:center;"> $x$ </th>
   <th style="text-align:center;"> $f(x|1)$ </th>
   <th style="text-align:center;"> $f(x|2)$ </th>
...
```{r likelihood_limited, fig.asp=.7, fig.width=6, message=FALSE, warning=FALSE, fig.cap='Likelihood function with a limited domain', fig.align='center', out.width='90%'}
x <- seq(0,3,by=0.001)
y <- (x-1)^2-5
