...
qqnorm(hsb$uhat_st, ylab = "Standardized level 1 residuals"); qqline(hsb$uhat_st, col=2)
```
...
qqnorm(hsb_selected$ehat,  ylab = "Standardized level 1 residuals"); qqline(hsb_selected$ehat, col=2)
```
