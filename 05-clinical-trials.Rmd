...
library(knitr)
library(kableExtra)
dt <- read.csv("/home/ccwang/Documents/full-website-content/static/files/clinicaltrials001.csv", header = T)
...
<caption>Table 2: Observed trial results compared to the `truth` of 1) no difference; 2) a true $\pi_1-\pi_2$ diffrence</caption>
 <thead>
<tr>
...
<table class="table table-striped table-bordered" style="margin-left: auto; margin-right: auto;">
<caption>Table 3: Values of $f(\alpha, \beta)$ for different levels of $\alpha$ and $\beta$</caption>
 <thead>
<tr>
...
library(knitr)
library(kableExtra)
dt <- read.csv("/home/ccwang/Documents/full-website-content/static/files/falphabeta.csv", header = T)
names(dt) <- c(" ", "0.05", "0.1", "0.2", "0.5")
dt[,1] <- c(" ", 0.05, 0.01)
