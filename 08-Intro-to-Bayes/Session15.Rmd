...
```{r introBayes15-fig08, cache=FALSE, fig.width=6, fig.height=3.5,  fig.cap="`traceplot(m13.7)`", fig.align='center', message=FALSE}
traceplot(m13.7)
```
...
```{r introBayes15-fig09, cache=FALSE, fig.width=6, fig.height=3.5,  fig.cap="`traceplot(m13.7nc)`", fig.align='center', message=FALSE}
traceplot(m13.7nc)
```
...
```{r introBayes15-fig10, cache=FALSE, fig.width=4, fig.height=3.5,  fig.cap="The devil's funnel.", fig.align='center', message=FALSE}
...
\begin{aligned}
L_i & \sim \text{Binomial}(1, p_i) \\ 
\text{logit}(p_i) & = \color{green}{\underbrace{\bar\alpha + z_{\text{ACTOR[i]}}\sigma_\alpha}_{\alpha_\text{ACTOR[i]}}} + \color{green}{\underbrace{x_{\text{BLOCK}[i]}\sigma_\gamma}_{\gamma_\text{BLOCK[i]}}} + \beta_{\text{TREATMENT}[i]} \\
