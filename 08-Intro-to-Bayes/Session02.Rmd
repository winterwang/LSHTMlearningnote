...
```{r 08-intro-to-Bayesfig1, fig.height=4, fig.width=5, fig.cap='Probability of a girl given placenta previa (BDA3, p.37).', fig.align='center', out.width='90%', cache=TRUE}
