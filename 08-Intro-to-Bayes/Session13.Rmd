...
```{r introBayes13-fig14, cache=TRUE, fig.width=5.5, fig.height=4.5,  fig.cap="Struggling with slope priors in a Poisson GLM. A flat prior produces explosive trends on the outcome scale.", fig.align='center'}
