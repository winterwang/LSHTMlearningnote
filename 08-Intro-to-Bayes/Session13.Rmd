...
可以看到男生平均要比女生被錄取的概率高 12% ~ 17%。在我們開始懷疑是不是有“系統性性別歧視”之前，讓我們先把觀察值和模型推測值繪製成圖來實際觀察到底有沒有男女錄取概率的差別 (圖 \@ref(fig:introBayes13-fig08))：
