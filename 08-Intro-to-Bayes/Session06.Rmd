...
```{r introBayes06-11, fig.height=4, fig.width=4.5, fig.cap='Plot adults height against weight.', fig.align='center', out.width='90%', cache=TRUE} 
...
```{r introBayes06-12, cache=TRUE, fig.height=4, fig.width=4, fig.cap='Prior predictive simulation for the height and weight model. Simulation using the beta ~ N(0, 10) prior.', fig.align='center', out.width='90%'}
set.seed(2971)
...
```{r introBayes06-13, cache=TRUE, fig.height=4, fig.width=4, fig.cap='Prior predictive simulation for the height and weight model. Simulation using the beta ~ N(0, 10) prior.', fig.align='center', out.width='90%'}
set.seed(4)
