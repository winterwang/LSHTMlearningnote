...
```{r DAG02, fig.asp=.7, fig.width=3.5, fig.cap="Conditioning on a collider", fig.align='center', out.width='90%', cache=TRUE}
g <- dagitty('dag {
    V1 -> V3 ;
    V2 -> V3 ; 
}')
...
```{r DAG03, fig.asp=.7, fig.width=3.5, fig.cap="Conditioning on a non-collider (1)", fig.align='center', out.width='90%', cache=TRUE}
g <- dagitty('dag {
    V1 <- V3 -> V2
}')
plot(graphLayout(g))
...
```{r DAG04, fig.asp=.7, fig.width=3.5, fig.cap="Conditioning on a non-collider (2)", fig.align='center', out.width='90%', cache=TRUE}
g <- dagitty('dag {
    V1 -> V3 -> V2
}')
plot(graphLayout(g))
