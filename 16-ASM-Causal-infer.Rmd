...
```{r prop_score01, echo=FALSE, fig.height=6, fig.width=8, fig.cap='Density and histogram of the estimated propensity score in the two exposure groups.', fig.align='center', out.width='80%', message=FALSE, warning=FALSE}
...
從圖 \@ref(fig:prop_score01) 可以看出評分在兩個暴露組中的分布交叉十分令人滿意。
...
use "backupfiles/RFA.dta" 
teffects psmatch (dodp) (rfa age gender i.smoke i.hospital nodules mets duration maxidia i.primary i.position, logit)

teffects psmatch (dodp) (rfa age gender i.smoke i.hospital nodules mets duration maxidia i.primary i.position, logit), atet
```
