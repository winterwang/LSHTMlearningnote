...
# 貝葉斯理論在正態分布數據中的應用 Normal distribution applying Bayes' Theorem
...
## graph 
curve(Post1, -5, 5, xlab = ~mu, ylab = "Probability Density", main = "Normal prior: m = 0, t = 1", lwd = 2, n = 10000, ylim = c(0, 0.7))
curve(Prior, xlab = ~theta, lwd = 1, lty = 2, add = T, n = 10000)
curve(likelihood, xlab = ~theta, lwd = 1, lty = 3, add = T, n = 10000)
...
## graph 
curve(Post1, -5, 5, xlab = ~mu, ylab = "Probability Density", main = "Normal prior: m = 0, t = 8", lwd = 2, n = 10000, ylim = c(0,1.2))
curve(Prior, xlab = ~theta, lwd = 1, lty = 2, add = T, n = 10000)
curve(likelihood, xlab = ~theta, lwd = 1, lty = 3, add = T, n = 10000)
