...
pkg <- c("knitr", "kfigr",  "plyr","tidyverse", "survival", "ggfortify", "survminer", "haven", "plotly","gridExtra", "Epi", "KMsurv", "gnm", "cmprsk", "mstate", "flexsurv", "splines", "epitools", "shiny", "epiR", "rgl", "ggplot2", "epiDisplay","margins" , "MASS", "psych", "lme4", "nlme", "grid", "sandwich", "kableExtra", "mvtnorm", "scatterplot3d", "car", "ggthemes", "ggsci", "DescTools", "limma", "binomTools", "ggthemr", "BSDA", "lmtest", "FSA", "exact2x2", "dagitty", "ATE", "lmerTest", "tableone", "stargazer","eha", "Hmisc", "ROCR", "PBSmodelling", "LogisticDx", "HLMdiag", "clubSandwich", "codetools", "TailRank", "BRugs", "coda", "R2OpenBUGS", "FactoMineR", "factoextra")
